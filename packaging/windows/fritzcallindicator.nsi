;FritzCallIndicator NSIS installer script
  ...
  !define MUI_ICON "fritzcallindicator.ico"
...
Section
  ...
  ;Add all files from folder FritzCallIndicator into installer (skip .md files)
  File /r /x *.md ${APPNAME}\*.*
  ...
  !insertmacro MUI_STARTMENU_WRITE_BEGIN Application
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuFolder\${APPNAME}.lnk" "$INSTDIR\FritzCallIndicator.exe"
